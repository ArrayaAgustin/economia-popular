...
namespace Api.CIDI
{
    public class UsuarioCidi : IUsuario
    {
        ...
        public bool GetTieneRepresentados => TieneRepresentados == "S";
        public bool EsCidiNivel2 => !string.IsNullOrEmpty(CUIL) && Id_Estado.HasValue && Id_Estado.Value == 2;
        public string CodigoPais => string.IsNullOrWhiteSpace(PaiCodPais) ? "ARG" : PaiCodPais;
    }
}
